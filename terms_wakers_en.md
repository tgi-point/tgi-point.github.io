Effective Date: Last updated + 30days
...
Application Store means the digital distribution service operated and developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) or others in which the Application has been downloaded.
...
User Account
Registration
If You’re using Our Service with an iOS device, You can register your account to Our Service by signing up with Your Apple account.

By signing up, You understand that You can use Our Service more conveniently with upcoming features. As of the latest update of this Agreement, You can use all features in Our Service without registration.

Deregistration
Registered User has the right to deregister anytime by completing Apple account removal process in Our Service.

You can register to Our Service again with the same Apple account after deregistration.
